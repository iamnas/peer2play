...
//           className={`px-6 py-2 rounded-xl transition-all duration-200 flex items-center gap-2 ${isWalletConnected
...
//               className={`w-full mt-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 transform hover:scale-[1.02] ${!isWalletConnected ? 'opacity-50 cursor-not-allowed' : 'hover:from-blue-600 hover:to-purple-600'
//                 }`}
//             >
          ...
          <form onSubmit={handleSwap}>
            ...
            <button
              ...
              className={`w-full mt-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 transform hover:scale-[1.02] ${
                !isConnected ? 'opacity-50 cursor-not-allowed' : 'hover:from-blue-600 hover:to-purple-600'
              }`}
            >
